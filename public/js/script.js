...
var users = {
	phineas: {
		username: 'UnusualAbsurd ᵈᵉᵛ',
		nameColor: 'hsl(345, 50%, 52%)',
		avatar: 'https://cdn.discordapp.com/avatars/746721583804055634/d5fc98b255b60f11f401ff8ae92679b1.png?size=256'
	},
	paragon: {
		username: 'Adv',
		nameColor: 'hsl(212, 51%, 59%)',
		bot: true,
		avatar: 'https://cdn.discordapp.com/avatars/902393086980816927/ac471bad7b7eec0d816672eb64e3fda5.png?size=256'
	}
};
...
var channelData = [{
	...
	messages: [{
		...
		user: users.paragon,
		embedData: {
			title: 'Adv Discord Bot',
			pill: 'hsl(202, 35%, 68%)',
			thumb: 'https://cdn.discordapp.com/avatars/902393086980816927/ac471bad7b7eec0d816672eb64e3fda5.png?size=256',
            fields: [{
				name: 'Commands Category',
				value: 'Moderation, Server Settings, Misc, Fun, Info'
			}, {
				name: '-> Open Source',
				value: 'https://github.com/UnusualAbsurd/adv-discord-bot'
            }, {
				name: '-> Support Server',
				value: 'discord.gg/pjrzgtzyfe'
			}, {
				name: '-> Default Invite',
				value: 'https://bit.ly/3Ep0Ei9'
			}, {
				name: '-> Admin Invite',
				value: 'https://bit.ly/3jJHMCw'
			}, {
				name: '-> Developer Profile',
				value: 'https://unusualabsurd.github.io'
			}]
		}
	}]
}];
...
function setChannel(name) {
	...
	demoEle.input.placeholder = 'Message #' + '💬general';
